...
class CustomEnv(gym.Env):
  ...
  def __init__(self, step_limit, step_size, maxspeed, acceleration, binary_reward, isEscaping, enemy_model, enemy_step_limit, enemy_step_size, enemy_maxspeed, enemy_acceleration, random_pos = False):
