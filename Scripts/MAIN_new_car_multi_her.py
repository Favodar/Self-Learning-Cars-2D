...
if(n_environments):
    stub_env = make_vec_env(GoalEnv, n_envs=16,env_kwargs={'static_enemy': True, 'discrete_actionspace': False, 'random_pos': 0, 'step_limit': 0, 'step_size': 0, 'maxspeed': 0, 'acceleration': 0,
                                                                           'binary_reward': 0, 'isEscaping': False, 'enemy_model': 0, 'enemy_step_limit': 0, 'enemy_step_size': 0, 'enemy_maxspeed': 0, 'enemy_acceleration': 0})
...
defender_name = "DEF6_H_rotVec_rdmPos_PPO2_" + "ep_length_" + str(defender_params.step_limit) + "turnrate_" + str(
...
attacker_name = "ATK6_H_nEnv_epsilon01_rotVec_rdmPos_HERSAC_" + "ep_length_" + str(attacker_params.step_limit) + "turnrate_" + str(
...
if(n_environments):
    vectorized_attacker_env = make_vec_env(GoalEnv, n_envs=16, env_kwargs={'static_enemy':True, 'discrete_actionspace':False, 'random_pos':attacker_params.random_pos, 'step_limit':attacker_params.step_limit, 'step_size':attacker_params.step_size, 'maxspeed':attacker_params.maxspeed, 'acceleration':attacker_params.acceleration, 'binary_reward':attacker_params.binary_reward, 'isEscaping':False, 'enemy_model':defender_model, 'enemy_step_limit':defender_params.step_limit, 'enemy_step_size':defender_params.step_size, 'enemy_maxspeed':defender_params.maxspeed, 'enemy_acceleration':defender_params.acceleration})
...
# Init learning with non-moving defender
