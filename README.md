...
- scripts for executing succesful training with PPO (HER + SAC in the works)  
...
If you're interested, you could either only download the environment and try to succesfully train an agent that learns the task on your own, or try to improve the existing solutions.
